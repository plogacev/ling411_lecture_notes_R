...
`r function_definition("as.double(...)", "")`
<br>
`r function_definition("sum(x)", "")`
<br>
`r function_definition("length(x)", "")`
<br>
`r function_definition("mean(x)", "")`
<br>
`r function_definition("rep(x)", "")`
<br>
`r function_definition("View(x)", "")`
<br>
`r function_definition("rbind(x)", "")`
<br>
`r function_definition("View(x)", "")`
<br>
`r function_definition("head(x)", "")`
<br>
`r function_definition("library(x)", "")`
<br>
