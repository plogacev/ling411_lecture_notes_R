...
### Operators
`r function_definition("%>%", "Pronounced: '(forward) pipe'.")`
<br>
`r function_definition("%>%", "Pronounced: 'assignment pipe'.")`
<br>

### Functions
`r function_definition("ifelse(condition, val_if_cond_true, val_if_cond_false)", "")`
<br>
